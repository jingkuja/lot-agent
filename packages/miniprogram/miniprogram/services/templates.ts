...
export const POSTER_TEMPLATES: PosterTemplate[] = [
  ...
  },
  {
    ...
    tone: "night",
    prompt:
      "招聘海报。主题：{{topic}}。深色背景，青色强调色，大标题「我们在找你」，中部岗位要点三条，底部投递方式位置。现代、克制、可直接发朋友圈。",
  },
  {
    id: "festival",
    title: "节日祝福",
  ...
  },
  {
    ...
    tone: "cyan",
    prompt:
      "活动横幅，16:9。主题：{{topic}}。左对齐中文主标题，背景是与主题相关的场景虚化，右侧留空。印刷青色点缀，适合做公众号头图。",
  },
];
